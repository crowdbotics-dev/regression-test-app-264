"""
Django settings for regression_test_app_264 project.
...
ROOT_URLCONF = 'regression_test_app_264.urls'
...
WSGI_APPLICATION = 'regression_test_app_264.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "regression_test_app_264 API",
    "DESCRIPTION": "API documentation for regression_test_app_264 App",
    "VERSION": "v1",
}
